...
var createTermClass = require(__dirname + '/term.js');
...
function r(thenify) {
  var Term = createTermClass(thenify);
  var self = this;
  var _r = function(x) {
...
r.prototype.setNestingLevel = function(nestingLevel) {
  if (typeof nestingLevel !== 'number')
    throw new Error.ReqlDriverError('The first argument of `setNestingLevel` must be a number.');
  this.nestingLevel = nestingLevel;
};
r.prototype.setArrayLimit = function(arrayLimit) {
  if (typeof arrayLimit !== 'number')
    throw new Error.ReqlDriverError('The first argument of `setArrayLimit` must be a number.');
...
function main(options) {
  var _r = new r(options.optionalRun !== false);
